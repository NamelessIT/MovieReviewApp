import { Search, Menu, User, ArrowDown, DownloadIcon, MoveDown, MoveDownIcon, ArrowDownIcon } from "lucide-react"
    ...
    <header className="bg-background border-b border-border px-4 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 header">
          <Button variant="ghost" size="sm" className="md:hidden header-menu-btn">
